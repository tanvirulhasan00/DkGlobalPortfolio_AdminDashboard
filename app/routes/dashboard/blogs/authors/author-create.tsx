...
import { createAuthor } from "~/redux/features/blogSlice";
...
const AuthorCreate = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    dispatch(createAuthor({ token: "", formPayload }));
    ...
    <div className="container mx-auto p-6">
      <div className={`bg-white rounded-2xl shadow-sm border border-gray-200`}>
        ...
        <div className="flex items-center space-x-3 p-6 border-b border-gray-100">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Add Author</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-3 p-6 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
            ...
            >
              {loading ? <LoadingSpinner /> : "Add Author"}
            </button>
          </div>
        </form>
      </div>
